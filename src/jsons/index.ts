...
import * as ImagePullPolicyOptions from './imagePullPolicyOptions.json';
import * as TLSModeOptions from './tlsModeOptions.json';

export { ProtocolOptions, LocationOptions, ResolutionOptions, MatchOptions, ServiceOptions, SessionAffinityOptions, ImagePullPolicyOptions, TLSModeOptions };