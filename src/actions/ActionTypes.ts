const ActionTypes = {
    ...
    INIT_CAPTAINDROPDOWNLIST: 'INIT_CAPTAINDROPDOWNLIST',
    FILL_CAPTAINDROPDOWNLIST: 'FILL_CAPTAINDROPDOWNLIST',
    INIT_CREDENTIALDROPDOWNLIST: 'INIT_CREDENTIALDROPDOWNLIST',
    FILL_CREDENTIALDROPDOWNLIST: 'FILL_CREDENTIALDROPDOWNLIST',
    INIT_GATEAREADROPDOWNLIST: 'INIT_GATEAREADROPDOWNLIST',
    FILL_GATEAREADROPDOWNLIST: 'FILL_GATEAREADROPDOWNLIST',
    INIT_QUAYAREADROPDOWNLIST: 'INIT_QUAYAREADROPDOWNLIST',
    FILL_QUAYAREADROPDOWNLIST: 'FILL_QUAYAREADROPDOWNLIST',
