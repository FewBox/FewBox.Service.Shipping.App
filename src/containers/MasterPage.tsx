                ...
                <Layout style={{ minHeight: '100vh' }}>
                    <Sider trigger={null} collapsible collapsed={this.state.collapsed}>
                        ...
                        <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
                            ...
                            <Menu.Item key="3">
                                <Link to='/master/fleet'><ContainerShipIcon />
                                    <FormattedMessage id="Navigation.Fleet" /></Link>
                            </Menu.Item>
                            <Menu.Item key="4">
                                <Link to='/master/shipyard'><ContainerShipIcon />
                            ...
                            <Menu.Item key="6">
                                <Link to='/master/custom'><ContainerShipIcon />
                        ...
                        <Content style={{ margin: '24px 16px', padding: 24, background: '#fff', minHeight: 280 }}>
                            <Suspense fallback={<Skeleton active />}>
                                <Switch>
                                    ...
                                    <Route path="/master/fleet" render={props => <FleetPage {...props} />} />
