    ...
    return (
      <HelpComponent isHelp={this.props.isHelp} helpContent={<FormattedMessage id="Help.ServiceAccount" />}>
        {this.props.form.getFieldDecorator('serviceAccount', {
          ...
          <Select showSearch placeholder={<FormattedMessage id='Label.ServiceAccount' />} optionFilterProp="children" suffixIcon={<ServiceAccountIcon style={{ color: 'rgba(0,0,0,.25)' }} />}>
