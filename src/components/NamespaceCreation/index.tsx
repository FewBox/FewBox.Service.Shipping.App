...
class NamespaceCreation extends React.PureComponent<INamespaceCreationProps> {
    handleSubmit = e => {
        e.preventDefault();
...
export default connect()(Form.create({ name: 'namespace_created' })(NamespaceCreation));