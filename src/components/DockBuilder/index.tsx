    ...
    public render() {
        ...
        var mooringComponents = this.props.mooringComponents.map((item, index) => {
            return <Row gutter={16} key={item.name + index}>
                ...
                <Col span={6}>
                    <Button shape="circle" icon="sub" onClick={() => { this.removeMooring(index); }} />
                </Col>
            </Row>
        });
        return (
            <Form onSubmit={this.handleSubmit}>
                ...
                <Row gutter={16}>
                    <Col span={24}>
                        <Button shape="circle" icon="plus" onClick={this.addMooring} />
                    </Col>
                </Row>
                <Row gutter={16}>
                    <Col span={6}>
