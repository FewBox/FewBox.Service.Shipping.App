export default {
    ...
    'Navigation.ShippingMap': 'Shipping Map',
    ...
    'Message.TypeRequired': 'Please input teh type!',
    ...
    'Label.ContainerItem': 'Container[{key}]',
    ...
    'Label.Healthz': 'Healthz',
    'Label.AutoRegisterCompletion': 'Auto Register Completion',
    'Label.Etcd': 'Etcd',
    'Label.Log': 'Log',
    'Label.Ping': 'Ping',
    'Label.Poststarthook_ApiserviceOpenapiController': 'PostStartHook Api Service OpenApi Controller',
    'Label.Poststarthook_ApiserviceRegistrationController': 'PostStartHook Api Service Registration Controller',
    'Label.Poststarthook_ApiserviceStatusAvailableController': 'PostStartHook Api Service Status Available Controller',
    'Label.Poststarthook_BootstrapController': 'PostStartHook Bootstrap Controller',
    'Label.Poststarthook_CARegistration': 'PostStartHook CA Registration',
    'Label.Poststarthook_GenericApiserverStartInformers': 'PostStartHook Generic Api Server Start Informers',
    'Label.Poststarthook_KubeApiserverAutoregistration': 'PostStartHook Kube Api Server Auto Registration',
    'Label.Poststarthook_Rbac_BootstrapRoles': 'PostStartHook Rbac Bootstrap Roles',
    'Label.Poststarthook_Rbacscheduling_BootstrapSystemPriorityClasses': 'PostStartHook Rbac Scheduling Bootstrap System Priority Classes',
