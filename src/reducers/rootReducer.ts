...
import containerTerminalPage from './containerTerminalReducer';
import customsPage from './customsReducer';
import logBookPage from './logBookReducer';

const appReducer = combineReducers({ masterPage, signinPage, landingPage, settingPage, shippingLinePage, containerShipPage, shipyardPage, containerTerminalPage, customsPage, logBookPage, routing });
